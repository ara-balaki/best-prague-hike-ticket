import type { Stop, Transport, TransportFilter } from '../types'
 ...
 */
export function isSuburban(stop: Stop, mode: Transport): boolean {
  return (
 ...
 */
export function highestZone(stop: Stop, transport: TransportFilter): number {
